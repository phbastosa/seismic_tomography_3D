...
plt.scatter(ry/dh, rx/dh, label = "Receivers")
plt.scatter(sy/dh, sx/dh, label = "Shots", color = "k")
...
plt.scatter(sx[-1]/dh, sz[-1]/dh, label = "Central shot", color = "k")
...
plt.xlabel("Z axis [m]", fontsize=17)
plt.scatter(sy[-1]/dh, sz[-1]/dh, label = "Central shot", color = "k")
