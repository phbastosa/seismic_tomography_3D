...
ax1.plot(np.arange(nx), np.ones(nx)*zxSlice, "--g")
ax1.plot(np.ones(ny)*zySlice, np.arange(ny), "--m")
...
ax2.plot(np.arange(nz), np.ones(nz)*zxSlice, "--g")
ax2.plot(np.ones(ny)*xySlice, np.arange(ny), "--r")
...
ax3.plot(np.arange(nx), np.ones(nx)*xySlice, "--r")
ax3.plot(np.ones(nz)*zySlice, np.arange(nz), "--m")
