...
plt.tight_layout()
plt.savefig("figures/ricker_zero_phase_a.png", dpi = 200)
plt.show()
...
plt.text(1.2,-0.15,"Re", weight = 'bold', fontsize = 12)
plt.text(0.05,-1.5,"Im", weight = 'bold', fontsize = 12)
plt.tight_layout()
plt.savefig("figures/ricker_zero_phase_b.png", dpi = 200)
plt.show()
...
plt.xlim([0,fmax/180])
plt.ylim([0,1+np.max(np.abs(dft_z_ricker))])
...
plt.ylabel("Amplitude", fontsize = 14)
plt.tight_layout()
plt.savefig("figures/ricker_zero_phase_c.png", dpi = 200)
plt.show()
...
plt.tight_layout()
plt.savefig("figures/ricker_zero_phase_d.png", dpi = 200)
plt.show()
#--------------------------------------------------------------
...
plt.ylabel("Amplitude", fontsize = 14)
plt.tight_layout()
plt.savefig("figures/ricker_min_phase_a.png", dpi = 200)
plt.show()
...
plt.text(0.05,-1.5,"Im", weight = 'bold', fontsize = 12)
plt.tight_layout()
plt.savefig("figures/ricker_min_phase_b.png", dpi = 200)
plt.show()
...
plt.xlim([0,fmax/180])
plt.ylim([0,1+np.max(np.abs(dft_m_ricker))])
plt.xticks(np.linspace(0,fmax/180, 7), np.linspace(0,fmax, 7, dtype = int))
plt.title("Espectro de amplitudes", fontsize = 18)
plt.xlabel("Frequência [Hz]", fontsize = 14)
plt.ylabel("Amplitude", fontsize = 14)
plt.tight_layout()
plt.savefig("figures/ricker_min_phase_c.png", dpi = 200)
plt.show()
...
plt.ylabel("Ângulo [°]", fontsize = 14)
plt.tight_layout()
plt.savefig("figures/ricker_min_phase_d.png", dpi = 200)
plt.show()
